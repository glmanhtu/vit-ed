...
_C.MODEL.TYPE = 'pjs'
# Model name
_C.MODEL.NAME = 'div2k_erosion7_4bin_patch8_64'
...
_C.MODEL.PJS = CN()
_C.MODEL.PJS.PATCH_SIZE = 16
_C.MODEL.PJS.IN_CHANS = 3
_C.MODEL.PJS.EMBED_DIM = 768
_C.MODEL.PJS.DEPTH = 8
_C.MODEL.PJS.C_DEPTH = 8
_C.MODEL.PJS.NUM_HEADS = 12
...
_C.MODEL.SS.DROPOUT = 0.
_C.MODEL.SS.N_CLASSES = 0
